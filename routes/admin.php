...
Route::group(['prefix' => 'version'], function () {
    Route::get('/', [Admin\VersionController::class, 'groups'])->name('admin.version');

    Route::post('/group', [Admin\VersionController::class, 'createGroup'])->name('admin.version.group');

    Route::delete('/group', [Admin\VersionController::class, 'deleteGroup']);

    Route::group(['prefix' => '{group}'], function () {
        Route::get('/', [Admin\VersionController::class, 'versions'])->name('admin.version.versions');

        Route::post('/edit', [Admin\VersionController::class, 'editGroup'])->name('admin.version.group.edit');
        Route::post('/version', [Admin\VersionController::class, 'createVersion'])->name('admin.version.version');
        Route::post('/version/{version}/edit', [Admin\VersionController::class, 'editVersion'])->name('admin.version.version.edit');

        Route::delete('/version', [Admin\VersionController::class, 'deleteVersion']);
    });
});
